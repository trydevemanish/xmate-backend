...
class Game(models.Model):
    ...
    player_1 = models.ForeignKey(User,related_name='game_as_player1',on_delete=models.CASCADE)
    player_2 = models.ForeignKey(User,related_name='game_as_player2', on_delete=models.CASCADE)
    moves = models.JSONField(default=list)
    winner = models.ForeignKey(User,related_name="game_won",null=True,blank=True, on_delete=models.SET_NULL)
